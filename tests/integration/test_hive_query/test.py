...
def test_hive_struct_type(started_cluster):
    ...
    expected_result = """1	2	3	4	5	6.11	7.22	8	2022-02-20 14:47:04	2022-02-20	hello world	hello world	hello world	true	[1,2,3]	['hello world','hello world']	[1.1,1.2]	{'a':100,'b':200,'c':300}	{'a':'aa','b':'bb','c':'cc'}	{'a':111.1,'b':222.2,'c':333.3}	('aaa',200,333.3)	2022-02-20"""
    assert result.strip() == expected_result
    ...
    expected_result = """2022-02-20	aaa"""
    assert result.strip() == expected_result
