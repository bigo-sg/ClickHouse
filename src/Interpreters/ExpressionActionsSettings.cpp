...
ExpressionActionsSettings ExpressionActionsSettings::fromSettings(const Settings & from, CompileExpressions compile_expressions)
{
    ...
    settings.enable_adaptive_reorder_short_circuit_arguments = from.enable_adaptive_reorder_short_circuit_arguments;
    settings.adaptive_reorder_short_circuit_arguments_sample_rows = from.adaptive_reorder_short_circuit_arguments_sample_rows;
    settings.max_arguments_for_adaptive_reorder_short_circuit_arguments = from.max_arguments_for_adaptive_reorder_short_circuit_arguments;
    return settings;
}
