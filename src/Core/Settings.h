...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(UInt64, adaptive_reorder_short_circuit_arguments_sample_rows, 512, "The number of rows to sample for adaptive reordering of short-circuit function arguments.", 0) \
    M(UInt64, max_arguments_for_adaptive_reorder_short_circuit_arguments, 128, "The maximum number of arguments for adaptive reordering of short-circuit function arguments.", 0) \
    \
