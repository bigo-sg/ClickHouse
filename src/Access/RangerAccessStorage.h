...
class RangerAccessStorage : public IAccessStorage
{
public:
    static constexpr char STORAGE_TYPE[] = "ranger";

    explicit RangerAccessStorage(const String & storage_name_, AccessControl * access_control_, const Poco::Util::AbstractConfiguration & config);
    virtual ~RangerAccessStorage() override = default;
